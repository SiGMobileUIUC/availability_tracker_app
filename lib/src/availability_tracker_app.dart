import 'package:availability_tracker_app/src/screens/home_screen.dart';
...
class AvailabilityTrackerApp extends StatefulWidget {
  const AvailabilityTrackerApp({super.key});

  @override
  State<AvailabilityTrackerApp> createState() => _AvailabilityTrackerAppState();
}

class _AvailabilityTrackerAppState extends State<AvailabilityTrackerApp> {
  @override
